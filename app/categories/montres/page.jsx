...
export default function BijouxPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Montres d'Exception",
    "description": "Découvrez notre sélection de montres de prestige : Rolex, Omega, Patek Philippe, Audemars Piguet et plus encore.",
    "url": `${baseUrl}/categories/montres`,
    "mainEntity": {
      "@type": "ItemList",
      "numberOfItems": total,
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Montres",
        "item": `${baseUrl}/categories/montres`
      }
    ]
  };
