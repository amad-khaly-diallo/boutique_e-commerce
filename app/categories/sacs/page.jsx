...
export default function BijouxPage() {
  ...
  const collectionSchema = {
    ...
    "@type": "CollectionPage",
    "name": "Sacs d'Exception",
    "description": "Birkin, Kelly, Chanel Classic, Dior Lady… Retrouvez les sacs les plus iconiques des maisons de luxe.",
    "url": `${baseUrl}/categories/sacs`,
    "mainEntity": {
      "@type": "ItemList",
      "numberOfItems": total,
